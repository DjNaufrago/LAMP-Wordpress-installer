...
startinstall() {
  ...
  echo "Unattended installation of LAMP Server" | tee -a /home/ubuntu/log.txt
...
finishcleanrestart() {
  echo "$(date "+%F - %T") - Assigning permissions to the web directory." | tee -a /home/ubuntu/log.txt
...
echo -e '\n' >> /home/ubuntu/log.txt
echo '# ============ MARIADB ROOT PASSWORD ============' >> /home/ubuntu/log.txt
