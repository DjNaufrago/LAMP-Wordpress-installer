...
configwp() {
  ...
  echo "=== Copies of the original configuration files were created:" >> log.txt
  echo "=== - /etc/apache2/mods-enabled/dir.conf.bk"
  echo "=== - /var/www/html/.htaccess.bk"
  echo "=== - /var/www/html/wp-config.php.bk"
  echo "=== - /etc/apache2/apache2.conf.bk"
}
